...
class EventWebSocketManager:
    ...
    async def listen_redis(self) -> None:
        ...
        logger.info("Subscribed to Redis channel %s", settings.redis_events_channel)
        ...
        while True:
            ...
            if message and message.get("type") == "message":
                try:
                    ...
                    logger.warning("Invalid event payload on Redis channel")
            await asyncio.sleep(0.05)


event_ws_manager = EventWebSocketManager()
